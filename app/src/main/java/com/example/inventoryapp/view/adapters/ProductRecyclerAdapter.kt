package com.example.inventoryapp.view.adapters
...
class ProductRecyclerAdapter(private val clickListener:RecyclerItemClickListener?) : RecyclerView.Adapter<ProductRecyclerAdapter.ViewHolder>() {
